...
class Settings(BaseSettings):
    ...
    # File metadata is stored in PostgreSQL. Binary objects can be stored
    # locally for development or in Supabase Storage for production.
    ...
    SUPABASE_STORAGE_CACHE_DIR: str = ".storage-cache"
